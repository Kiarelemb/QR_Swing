...
public class QRRoundButton extends QRButton {
    ...
    public void componentFresh() {
        ...
        setForeground(isEnabled() ? QRColorsAndFonts.MENU_COLOR : QRColorsAndFonts.LINE_COLOR);
    }
    ...
    public void setEnabled(boolean b) {
        super.setEnabled(b);
        setForeground(b ? QRColorsAndFonts.MENU_COLOR : QRColorsAndFonts.LINE_COLOR);
    }
}